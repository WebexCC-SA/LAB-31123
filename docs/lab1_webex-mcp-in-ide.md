...
10. After that, the Output view should open automatically, if not, choose View -> Output.
    ...
    ![Tools](./assets/tools_2.png){ width="850" style="display: block; margin: 0 auto; border: 1px solid lightgray; border-radius: 8px;"}
...
??? Solution
    ...
    1. To add the new MCP server, you will first need to create a new token.
        ...
        ![Create_token](./assets/token_5.png){ width="850" style="display: block; margin: 0 auto; border: 1px solid lightgray; border-radius: 8px;"}
    ...
    3. Save the file, and start the server. For that open the Command Palette `Ctrl+Shift+P`, and type "MCP: List Servers", select the newly added server and click "Start Server". If it work, you will see that 8 tools have been found in the Output tab:
        ...
        ![Tools](./assets/tools_1.png){ width="850" style="display: block; margin: 0 auto; border: 1px solid lightgray; border-radius: 8px;"}
...
??? Solution
    ...
    * I need to schedule a meeting with user1@webexone-ai-assistant.wbx.ai tomorrow at 6PM CET time.
    ...
    ![Meeting](./assets/meeting_1.png){ width="850" style="display: block; margin: 0 auto; border: 1px solid lightgray; border-radius: 8px;"}

    Once done, it will provide you with the meeting details:

    ![Meeting](./assets/meeting_2.png){ width="850" style="display: block; margin: 0 auto; border: 1px solid lightgray; border-radius: 8px;"}

    You can check from your Webex App that the meeting was scheduled:

    ![Meeting](./assets/meeting_3.png){ width="850" style="display: block; margin: 0 auto; border: 1px solid lightgray; border-radius: 8px;"}

    And confirm the participants:

    ![Meeting](./assets/meeting_4.png){ width="850" style="display: block; margin: 0 auto; border: 1px solid lightgray; border-radius: 8px;"}
